...
**You may open a PR for typos or any other correction**
...
### Windows Settings
 ...
 We'll disable most of them using GPOs but you should still take a a look at them and change them because it doesn't hurt to check it again.
...
I came accross this [GitHub Repositery By Starchturrets](https://github.com/starchturrets/windows-shenanigans/tree/main/WDAC) which has some policies for Windows. This repo also contains a basic WDAC Policy srcipt. If you're making use of WDAC policies, make sure you are using the **Deafult Windows Mode** mentioned there. It doesn't break anything for me, you should first try using all your apps for a day, if nothing breaks then keep it enabled. I'm using 3rd template and also making use of falsely blocked allowlist to enable apps flagged for nothing. WDAC notes are well versed and explained line by line, you should check them out here.

The most important policies you should consider when setting up Windows in an Eneterprise Worksapce is [CIS (Center of Internet Security)] Windows Security Baseline (https://learn.microsoft.com/en-us/windows/security/operating-system-security/device-management/windows-security-configuration-framework/windows-security-baselines). They have provided a [list](https://learn.microsoft.com/en-us/mem/intune/protect/security-baseline-settings-mdm-all?pivots=mdm-23h2) with detailed explanation. You will need to check and make sure everything is working afterwards because if it doesn't you need to troubleshoot the issue yourself. If you want to create a final policy for all the system and have the most control, be ready for fixing any issues you will come accross down the line.